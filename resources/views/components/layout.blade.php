<x-head>
    ...
    <div class="fixed-bottom">
        <div class="container m-0 p-0 mw-100">
            <ul class="nav justify-content-between navbar-bottom-ul w-100">
                ...
                {{-- Notifications (component renders its own <li>) --}}
    ...
    <div class="container container-custom-main mt-3">
        {{-- Livewire page content slot --}}
        {{ $slot ?? '' }}

        {{-- Traditional controller views that call @extends/@section --}}
        @yield('content')
    </div>

    <!-- Bootstrap Toasts (global) -->
      ...
      <div class="container py-5">
        <div class="row gy-5">
          ...
          <div class="col-12 col-lg-2 text-center text-lg-start">
            ...
            <a href="{{ route('institutions.register') }}"
