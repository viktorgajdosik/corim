                    ...
                    <div class="card-body">
                        <form method="POST" action="/users/authenticate" novalidate>
                            ...
                            <div class="form-floating mb-3">
                                <input type="email" class="form-control form-control-md @error('email') is-invalid @enderror" id="email" placeholder="Enter email" required name="email" value="{{ old('email') }}">
